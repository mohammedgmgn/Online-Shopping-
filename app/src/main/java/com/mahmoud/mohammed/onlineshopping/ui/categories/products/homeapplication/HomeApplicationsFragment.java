package com.mahmoud.mohammed.onlineshopping.ui.categories.products.homeapplication;
...
public class HomeApplicationsFragment extends Fragment implements ProductView,onProductClickListener {

    @BindView(R.id.home_app_recycler_view_id)
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View root = inflater.inflate(R.layout.fragment_home_applications, container, false);
