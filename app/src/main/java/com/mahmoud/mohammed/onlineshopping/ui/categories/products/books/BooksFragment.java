package com.mahmoud.mohammed.onlineshopping.ui.categories.products.books;
...
public class BooksFragment extends Fragment implements ProductView,onProductClickListener{
    @BindView(R.id.books_recycler_view_id)
