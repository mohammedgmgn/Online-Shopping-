package com.mahmoud.mohammed.onlineshopping.ui.categories.products.lifestyle;
...
public class LifeStyleFragment extends Fragment implements ProductView,onProductClickListener {
    @BindView(R.id.life_style_recycler_view_id)
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View root = inflater.inflate(R.layout.fragment_life_style, container, false);
    ...
    private void initUi() {
        presnter.getLifeStyleProductList();
